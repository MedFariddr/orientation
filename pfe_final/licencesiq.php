...
<body style="background-color: #F4F6F6">
    ...
    <article style="margin-left: 2%">
        ...
        <article style="margin-left: 5%">
            <h3 style="color: #C1E1A6"><b>3ème année</b></h3><a href="ProgrammeL3SIQ" style="margin-left: 3%"><b>Programme modules</b></a>
            <article style="margin-left: 3%">
        ...
        <article style="margin-left: 5%">
        <p>Lorsqu'on obtient un diplôme de licence SIQ on peut exercé ses métiers : </p>
        <ul>
